...
- In all union-find modes (Quick Find / Quick Find - Full / Quick Union / Quick Union - Full), Animation panel includes a `display connections` toggle (default OFF). Its state is persisted in `localStorage`, so your preference is reused on next visit.
