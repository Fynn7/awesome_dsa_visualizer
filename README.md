...
- In both Quick Find modes, Animation panel includes a `display connections` toggle (default OFF). Its state is persisted in `localStorage`, so your preference is reused on next visit.
